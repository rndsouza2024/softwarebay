...
import networkp1Data from '../../public/networkp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/network-page1/',
  headline: 'Download Network | Softwarebay™',
  url: 'https://softwarebay.vercel.app/network-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/network.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      ...
      position: 3,
      name: 'Network Page 1',
      item: 'https://softwarebay.vercel.app/network-page1/'
    }
  ]
})
const networkp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/network-page1/' />
        <meta
          name='robots'
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/network-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, network, network, network, network, graphic design, file sharing, network, network, network, browser'
        />
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/network.webp'
        />
        <meta name='network-web-app-capable' content='yes' />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>networkp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {networkp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/network-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="network" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/networkp1.json')
