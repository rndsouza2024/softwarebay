...
import securityp1Data from '../../public/securityp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/security-page1/',
  headline: 'Download Security | Softwarebay™',
  url: 'https://softwarebay.vercel.app/security-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/security.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      ...
      item: 'https://softwarebay.vercel.app/security-page1/'
    }
  ]
})
const securityp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/security-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Security | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/security-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, security, security, security, security, security, graphic design, file sharing, security, security, security, browser'
        />
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/security.webp'
        />
        <meta name='security-web-app-capable' content='yes' />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>securityp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {securityp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/security-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="security" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/securityp1.json')
