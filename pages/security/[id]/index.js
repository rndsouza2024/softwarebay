...
const securityDetail = ({ securityItem }) => {
  ...
  }, [securityItem, enableNoiseCancellation])
        ...
        <div className='flex-container'>
          <div className='category-container'>
            ...
            >
              ...
              {' '}
              Author: {securityItem.group}.
            </h2>
             <Image
                src={securityItem.directorimg}
                alt={securityItem.group}
                width={100}
                height={100}
                quality={90}
                objectFit='cover'
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={securityItem.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {securityItem.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {securityItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {securityItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={securityItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${securityItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
