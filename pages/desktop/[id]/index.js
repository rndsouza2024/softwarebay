...
const desktopDetail = ({ desktopItem }) => {
  ...
  }, [desktopItem, enableNoiseCancellation])
  ...
  return (
    <div>
      <Head>
        ...
        <meta name='keywords' content={`${desktopItem && desktopItem.keywords}`} />
        ...
        <div className='flex-container'>
          <div className='category-container'>
            ...
            >
              ...
              {' '}
              Author: {desktopItem.group}.
            </h2>
             <Image
                src={desktopItem.directorimg}
                alt={desktopItem.group}
                width={100}
                height={100}
                quality={90}
                objectFit='cover'
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={desktopItem.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {desktopItem.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {desktopItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {desktopItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={desktopItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${desktopItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
                    ...
                    {showTimer && seconds <= 0 && (
                      <div>
                        ...
                        {desktopItem.downloadlink1 && (
                          <Link href={desktopItem.downloadlink1} target='_blank'>
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
                              style={{
                                margin: 'auto',
