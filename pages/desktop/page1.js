...
import desktopp1Data from '../../public/desktopp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/desktop-page1/',
  headline: 'Download Desktop | Softwarebay™',
  url: 'https://softwarebay.vercel.app/desktop-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/desktop.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      ...
      position: 3,
      name: 'Dsektop Page 1',
      item: 'https://softwarebay.vercel.app/desktop-page1/'
    }
  ]
})
const desktopp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/desktop-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Desktop | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/desktop-page1'
        />
        ...
        <meta
          ...
          content='https://softwarebay.vercel.app/wp-content/uploads/desktop.webp'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>desktopp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {desktopp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/desktop-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="desktop" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/desktopp1.json')
