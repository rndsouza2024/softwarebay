...
const moviesDetail = ({ moviesp1Item }) => {
  ...
  }, [moviesp1Item, enableNoiseCancellation])
  ...
  const softwareSchema = JSON.stringify({
    ...
    softwareVersion: moviesp1Item.softwareVersion,
    url: moviesp1Item.siteurl,
    operatingSystem: moviesp1Item.operatingSystem,
    applicationCategory: moviesp1Item.applicationCategory,
    image: moviesp1Item.image,
    name: moviesp1Item.name,
    interactionStatistic: moviesp1Item.interactionStatistic,
    offers: {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: moviesp1Item.siteurl,
        name: `${moviesp1Item.name} | Softwarebay`,
        datePublished: moviesp1Item.datePublished,
        dateModified: moviesp1Item.dateModified,
        isPartOf: {
          '@id': 'https://softwarebay.vercel.app#website'
      ...
      },
      {
        ...
        headline: `Download ${moviesp1Item.name} | Softwarebay`,
        datePublished: moviesp1Item.datePublished,
        dateModified: moviesp1Item.dateModified,
        articleSection: 'Other Software',
        author: {
          '@id': 'https://softwarebay.vercel.appauthor/moviesp1Item/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        ...
        image: moviesp1Item.image,
        name: `Download ${moviesp1Item.name} | Softwarebay`,
        isPartOf: {
          '@id': `${moviesp1Item.siteurl}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Download {moviesp1Item && moviesp1Item.name} | Softwarebay</title>
        ...
        <meta
          property='og:title'
          content={`${moviesp1Item && moviesp1Item.name} - Softwarebay`}
        />
        <meta
  ...
  <Pagination
        ...
        <div className='flex-container'>
          <div className='category-container'>
            <Image
              src={moviesp1Item.channelposter}
            ...
            >
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={moviesp1Item.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {moviesp1Item.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {moviesp1Item.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {moviesp1Item.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={moviesp1Item.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${moviesp1Item.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
                    ...
                    {showTimer && seconds <= 0 && (
                      <div>
                        {moviesp1Item.downloadlink && (
                          <Link href={moviesp1Item.downloadlink} target='_blank'>
                            <div
                        ...
                        {moviesp1Item.downloadlink1 && (
                          <Link href={moviesp1Item.downloadlink1} target='_blank'>
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
                              style={{
                                margin: 'auto',
                        ...
                        {moviesp1Item.additionalLinks?.map((link, index) => (
              ...
              <Image
                src={moviesp1Item.image1}
                alt={moviesp1Item.name}
                width={1280}
                height={720}
                quality={90}
                objectFit='cover'
              ...
              <div className='flex flex-col items-center justify-center'>
                {moviesp1Item.head2 && (
                  <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300 text-bg text-black text-bg mt-2 text-3xl mb-2 items-center justify-center'>
                    <strong>{moviesp1Item.head2}</strong>
                  </p>
                )}

                {moviesp1Item.image2 && (
                  <Image
                    src={moviesp1Item.image2}
                    alt={moviesp1Item.name}
                    width={1280}
                    height={720}
                    quality={90}
