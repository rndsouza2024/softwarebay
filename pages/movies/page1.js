...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/movies-page1/',
  headline: 'Download movies | Softwarebay™',
  url: 'https://softwarebay.vercel.app/movies-page1/',
  description:
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      ...
      position: 3,
      name: 'Movies Page 1',
      item: 'https://softwarebay.vercel.app/movies-page1/'
    }
  ]
})
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/movies-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Movies | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/movies-page1'
        />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/moviesp1.json')
