...
const softwareSchema = JSON.stringify({
  ...
  softwareVersion: 'Other Software 2024',
  url: 'https://softwarebay.vercel.app/movies/',
  operatingSystem: 'Windows',
  applicationCategory: 'Other Software',
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
       <Head>
        <title> Download Other Software | Softwarebay</title>
       ...
       <meta name='robots' content='index, follow' />
        ...
        <meta
          property='og:title'
          content=" Download Other Software | Softwarebay"
        />
        <meta
      ...
      <Script src="../../propler/ads.js" defer />
        ...
        <h1  className='badge bg-gradient-to-r from-pink-500 to-amber-500 font-bold py-3 px-6  shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'  style={{
          ...
          textAlign: 'center',
          marginBottom: '15px'
        }}>SoftwareBay Other Software Section.</h1>
