...
const mobileDetail = ({ mobileItem }) => {
  ...
  }, [mobileItem, enableNoiseCancellation])
        ...
        <div className='flex-container'>
          <div className='category-container'>
            ...
            >
              ...
              {' '}
              Author: {mobileItem.group}.
            </h2>
             <Image
                src={mobileItem.directorimg}
                alt={mobileItem.group}
                width={100}
                height={100}
                quality={90}
                objectFit='cover'
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={mobileItem.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {mobileItem.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {mobileItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {mobileItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={mobileItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${mobileItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
