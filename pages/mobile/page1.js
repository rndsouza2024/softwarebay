...
import mobilep1Data from '../../public/mobilep1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/mobile-page1/',
  headline: 'Download mobile | Softwarebay™',
  url: 'https://softwarebay.vercel.app/mobile-page1/',
  description:
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      ...
      position: 3,
      name: 'Mobile Page 1',
      item: 'https://softwarebay.vercel.app/mobile-page1/'
    }
  ]
})
const mobilep1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/mobile-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Mobile | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/mobile-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, movies, mobile, mobile, graphic design, file sharing, mobile, mobile, mobile, browser'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>mobilep1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {mobilep1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/mobile-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="mobile" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/mobilep1.json')
