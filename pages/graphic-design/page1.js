...
import graphicdesignp1Data from '../../public/graphicdesignp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/graphic-design-page1/',
  headline: 'Download graphic-design | Softwarebay™',
  url: 'https://softwarebay.vercel.app/graphic-design-page1/',
  description:
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'Graphic Design Page 1',
      item: 'https://softwarebay.vercel.app/graphic-design-page1/'
    }
  ]
})
const graphicdesignp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/graphic-design-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Graphic Design | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/graphic-design-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, movies, mobile, graphic-design, graphic design, file sharing, graphic-design, graphic-design, graphic-design, browser'
        />
      ...
      >
        SoftwareBay Graphic Design Section.
      </h1>
      <Marquee />
      {/* <p
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>graphic-designp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {graphicdesignp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/graphic-design-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="graphic-design" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/graphic-designp1.json')
...
export default graphicdesignp1
