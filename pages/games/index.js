...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/games/',
  'headline': 'Download Games | Softwarebay™',
  'url': 'https://softwarebay.vercel.app/games/',
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
       <Head>
        ...
        <link rel='canonical' href="https://softwarebay.vercel.app/games/" />
        <meta
          name='robots'
       ...
       <meta name='robots' content='index, follow' />
        ...
        <meta
          property='og:title'
          content=" Download Games | Softwarebay"
        />
        <meta
...
<p
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>games Section</h1> */}
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://softwarebay.vercel.app/games.json');
