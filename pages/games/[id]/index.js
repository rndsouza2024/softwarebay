...
const gamesDetail = ({ gamesItem }) => {
  ...
  // useEffect(() => {
  //   const loadDailymotionAPI = () => {
  //     if (typeof window !== 'undefined' && typeof window.DM === 'undefined') {
  //       const script = document.createElement('script');
  //       script.src = 'https://api.dmcdn.net/all.js';
  //       script.async = true;
  //       script.onload = () => {
  //         console.log('Dailymotion API script loaded');
  //         setPlayerReady(true);
  //       };
  //       script.onerror = () => {
  //         console.error('Failed to load Dailymotion API script');
  //       };
  //       document.body.appendChild(script);
  //     } else {
  //       console.log('Dailymotion API already loaded');
  //       setPlayerReady(true);
  //     }
  //   };
  ...
  //     const videoId = gamesItem.videoitem[0];
  //     if (!videoId) {
  ...
  //     playerRef.current = window.DM.player(playerElement, {
  //       video: videoId,
  //       width: '100%',
  //       height: '100%',
  //       params: {
  ...
  //     playerRef.current.addEventListener('apiready', () => {
  ...
  //     playerRef.current.addEventListener('video_end', () => {
  ...
  }, [gamesItem, enableNoiseCancellation])
        ...
        <div className='flex-container'>
          <div className='category-container'>
            ...
            >
              ...
              {' '}
              Author: {gamesItem.group}.
            </h2>
             <Image
                src={gamesItem.directorimg}
                alt={gamesItem.group}
                width={100}
                height={100}
                quality={90}
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={gamesItem.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {gamesItem.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {gamesItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {gamesItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={gamesItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${gamesItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
