...
import gamesp1Data from '../../public/gamesp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/games-page1/',
  headline: 'Download Games | Softwarebay™',
  url: 'https://softwarebay.vercel.app/games-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/games.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Games',
      item: 'https://softwarebay.vercel.app/games/'
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'Games Page 1',
      item: 'https://softwarebay.vercel.app/games-page1/'
    }
  ]
})
const gamesp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Download Games | Softwarebay™</title>
        <link rel='canonical' href='https://softwarebay.vercel.app/games-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Games | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/games-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, movies, mobile, games, graphic design, file sharing, games, games, games, browser'
        />
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/games.webp'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>gamesp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {gamesp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/games-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="games" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/gamesp1.json')
