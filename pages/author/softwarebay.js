...
export default function ytmag ({ movie }) {
    ...
    const handleSearch = (event) => {
        ...
        if (searchTermLower.includes('tv show')) {
            searchURL = `https://www.google.com/search?q=site:https://softwarebay.vercel.app
tvshow/${encodeURIComponent(searchTermLower)}-2024`;
        } else {
            searchURL = `https://www.google.com/search?q=site:https://softwarebay.vercel.app
movie/${encodeURIComponent(searchTermLower)}-2024`;
        }
            ...
            <h1 className="flex flex-col text-center py-5 font-bold text-3xl items-center justify-center" style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Softwarebay - Explore. Discover. Download. </h1>
                <div className="container" style={{justifyContent: 'center', alignItems: 'center', height: '10vh', marginTop: '100px', }}>
                    <div className="home-main">
                        <div className="hm-logo"><a title="" href="https://softwarebay.vercel.app
" id="logo-home"></a></div>
                        ...
                        <div className="hm-button"><a href="https://softwarebay.vercel.app
" className="btn btn-lg btn-successful" style={{ color: '#40D7BC', fontSize: '24px', textShadow: '3px 5px 5px #000' }}>Youtube Magazine™</a></div>
                    </div>
                </div>
            </div>
        </div>
