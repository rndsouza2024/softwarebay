...
const browsersDetail = ({ browsersItem }) => {
  ...
  }, [browsersItem, enableNoiseCancellation])
        ...
        <div className='flex-container'>
          <div className='category-container'>
            ...
            >
              ...
              {' '}
              Author: {browsersItem.group}.
            </h2>
             <Image
                src={browsersItem.directorimg}
                alt={browsersItem.group}
                width={100}
                height={100}
                quality={90}
                objectFit='cover'
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={browsersItem.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {browsersItem.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {browsersItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {browsersItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={browsersItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${browsersItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
                    ...
                    {showTimer && seconds <= 0 && (
                      <div>
                        ...
                        {browsersItem.downloadlink1 && (
                          <Link href={browsersItem.downloadlink1} target='_blank'>
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
                              style={{
                                margin: 'auto',
                        ...
                        {browsersItem.additionalLinks?.map((link, index) => (
