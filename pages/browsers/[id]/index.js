  ...
  return (
    <div>
      <Head>
        ...
        <title>
          {' '}
          Download {browsersItem && browsersItem.name} | Softwarebay
        </title>
        ...
        <meta
          name='keywords'
          content={`${browsersItem && browsersItem.keywords}`}
        />
      ...
      >
        ...
        <div className='flex-container'>
          ...
          */}
                    ...
                    {seconds === 0 && (
                      <>
                        {browsersItem.downloadlink && (
                          <Link
                            href={browsersItem.downloadlink}
                            target='_blank'
                          >
                            <div
                        ...
                        {browsersItem.downloadlink1 && (
                          <Link
                            href={browsersItem.downloadlink1}
                            target='_blank'
                          >
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300 text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
