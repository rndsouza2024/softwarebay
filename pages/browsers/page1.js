...
import browsersp1Data from '../../public/browsersp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/browsersp1/',
  headline: 'Download Browser | Softwarebay™',
  url: 'https://softwarebay.vercel.app/browser-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/browser.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://softwarebay.vercel.app/browser-page1/'
  },
  additionalProperty: {
    '@type': 'PropertyValue',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Browser',
      item: 'https://softwarebay.vercel.app/browser/'
    },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Browser Page 1',
      item: 'https://softwarebay.vercel.app/browser-page1/'
    }
  ]
})
const browsersp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Download Browser | Softwarebay™</title>
        <link rel='canonical' href='https://softwarebay.vercel.app/browser-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Browser | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/browser-page1'
        />
        ...
        <meta
          ...
          content='https://softwarebay.vercel.app/wp-content/uploads/browser.webp'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>browsersp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {browsersp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/browser-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="browsers" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/browsersp1.json')
