...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/browsers/',
  headline: 'Download browsers | Softwarebay™',
  url: 'https://softwarebay.vercel.app/browsers/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/browsers.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Browsers',
      item: 'https://softwarebay.vercel.app/browsers/'
    }
  ]
})

const browsersPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/browsers/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download browsers | Softwarebay' />
        <meta
        ...
        <meta property='og:url' content='https://softwarebay.vercel.app/browsers' />

        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/browsers.webp'
        />
        ...
        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, movies, mobile, games, graphic design, file sharing, education, development, browsers, browser'
        />
        <meta
          property='og:image'
          content='https://softwarebay.vercel.app/wp-content/uploads/browsers.webp'
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>browsers Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {browsersData.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/browsers/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/browsers.json')
