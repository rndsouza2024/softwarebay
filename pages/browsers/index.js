...
const softwareSchema = JSON.stringify({
  ...
  softwareVersion: 'browsers 2024',
  url: 'http://softwarebay.vercel.app/browsers/',
  operatingSystem: 'Windows',
  applicationCategory: 'browsers',
  image: 'http://softwarebay.vercel.app/og_image.jpg',
  name: 'browsers',
  ...
  aggregateRating: {
    ...
    '@id': 'http://softwarebay.vercel.app/browsers/',
    ratingValue: 8,
    ratingCount: 0,
    bestRating: '10',
    worstRating: '1'
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'browsers',
      item: 'http://softwarebay.vercel.app/browsers/'
    },
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
       <Head>
        ...
        <link rel='canonical' href="http://softwarebay.vercel.app/browsers/" />
        <meta
          name='robots'
       ...
       <meta name='robots' content='index, follow' />
        ...
        <meta
          property='og:title'
          content=" Download browsers | Softwarebay"
        />
        <meta
        ...
        <meta
          ...
          content='Explore. Discover. Download - Free Your Desired Software.'
        />
        <meta property='og:url' content= "http://softwarebay.vercel.app/browsers"/>
   ...
   {/* <div className='container'> */}
        <h1  className='badge bg-gradient-to-r from-pink-500 to-amber-500 font-bold py-3 px-6  shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'  style={{
          ...
          textAlign: 'center',
          marginBottom: '15px'
        }}>Welcome to SoftwareBay Browsers Section.</h1>
...
export async function getStaticProps() {
  try {
    const res = await fetch('http://softwarebay.vercel.app/browsers.json');
