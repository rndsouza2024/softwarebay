...
const softwareSchema = JSON.stringify({
  ...
  softwareVersion: 'Browser 2024',
  url: 'https://softwarebay.vercel.app/browser/',
  ...
  aggregateRating: {
    ...
    '@id': 'https://softwarebay.vercel.app/browser/',
    ratingValue: 8,
    ratingCount: 0,
    bestRating: '10',
    worstRating: '1'
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
       <Head>
        ...
        <link rel='canonical' href="https://softwarebay.vercel.app/browser/" />
        <meta
          name='robots'
       ...
       <meta name='robots' content='index, follow' />
        ...
        <meta
          property='og:title'
          content=" Download Browser | Softwarebay"
        />
        <meta
        ...
        <meta
          ...
          content='Explore. Discover. Download - Free Your Desired Software.'
        />
        <meta property='og:url' content= "https://softwarebay.vercel.app/browser"/>
   ...
   <div className='container'>
        <h1  className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-3xl font-bold hover:text-blue-800'  style={{
          ...
          textAlign: 'center',
          marginBottom: '15px'
        }}>Welcome to SoftwareBay - Browser Section.</h1>
      ...
      >
        ...
        >
          ...
          <button className='border border-black p-2 m-1 hover:bg-orange-100'>
            ...
            <button className='border border-black p-2 m-1 hover:bg-orange-100'>
              <li id='menu-item-11606' className='menu-browser'>
                <a
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>browser Section</h1> */}
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://softwarebay.vercel.app/browser.json');
