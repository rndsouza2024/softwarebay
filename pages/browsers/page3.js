...
import browsersp3Data from '../../public/browsersp3.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/browsersp3/',
  headline: 'Download Browsers | Softwarebay™',
  url: 'https://softwarebay.vercel.app/browsersp3/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Browsers',
      item: 'https://softwarebay.vercel.app/browsersp3/'
    }
  ]
})
const browsersp3 = ({ items }) => {
  const [latest, setLatest] = useState(latestData)
  const [currentPage, setCurrentPage] = useState(1)
  const totalPages = 3 // Assume there are 3 pages

  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Download Browsers | Softwarebay™</title>
        <link rel='canonical' href='https://softwarebay.vercel.app/browsersp3/' />
        <meta
          name='robots'
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/browsersp3'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>browsersp3 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {browsersp3Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/browser-page3/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/browsersp3.json')
