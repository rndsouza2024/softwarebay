...
import browsersp2Data from '../../public/browsersp2.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/browsersp2/',
  headline: 'Download Browsers | Softwarebay™',
  url: 'https://softwarebay.vercel.app/browsersp2/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Browsers',
      item: 'https://softwarebay.vercel.app/browsersp2/'
    }
  ]
})
const browsersp2 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/browsersp2/' />
        <meta
          name='robots'
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/browsersp2'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>browsersp2 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {browsersp2Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/browser-page2/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/browsersp2.json')
