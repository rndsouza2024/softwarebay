...
import multimediap1Data from '../../public/multimediap1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/multimedia-page1/',
  headline: 'Download Multimedia | Softwarebay™',
  url: 'https://softwarebay.vercel.app/multimedia-page1/',
  description:
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'Multimedia Page 1',
      item: 'https://softwarebay.vercel.app/multimedia-page1/'
    }
  ]
})
const multimediap1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/multimedia-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Multimedia | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/multimedia-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, multimedia, multimedia, multimedia, graphic design, file sharing, multimedia, multimedia, multimedia, browser'
        />
        ...
        />
        <meta name='multimedia-web-app-capable' content='yes' />
      ...
      >
        SoftwareBay Multimedia Section.
      </h1>
      <Marquee />
      {/* <p
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>multimediap1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {multimediap1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/multimedia-page1/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/multimediap1.json')
