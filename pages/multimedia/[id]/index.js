  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        author: {
          '@id': 'http://softwarebay.vercel.appauthor/multimediaItem/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Download {multimediaItem && multimediaItem.name} | Softwarebay</title>
        ...
        <meta
          ...
          content='Explore. Discover. Download - Free Your Desired Software.'
        />
        <meta property='og:url' content={`${multimediaItem && multimediaItem.url}`} />
        <meta name='keywords' content={`${multimediaItem && multimediaItem.keywords}`} />
      ...
      >
        ...
        >
          ...
          >
            ...
            <button className='border border-black p-2 m-1 hover:bg-orange-100'>
              <li id='menu-item-11606' className='menu-multimediaItem'>
                <a
          ...
          <div className='category-container'>
           ...
           <h2
              ...
              <p className='text-black text-bg font-semibold mt-2'>
                License: {multimediaItem.license}, Version: {multimediaItem.version}
              </p>
              <p className='text-black text-bg font-semibold mt-2'>
