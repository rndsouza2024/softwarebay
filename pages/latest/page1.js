...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/latest-page1/',
  headline: ' Latest Blog | Softwarebay™',
  url: 'https://softwarebay.vercel.app/latest-page1/',
  description:
    'SoftwareBay is the top platform for exploring and downloading software,the premier platform for the Latest Blog releases and secure downloads.',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Latest Blog',
      item: 'https://softwarebay.vercel.app/latest/'
    },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Latest Page 1',
      item: 'https://softwarebay.vercel.app/latest-page1/'
    }
  ]
})

const latestpage1Page = ({ items }) => {
  const [latest, setLatest] = useState(latestp1Data)
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title>  Latest Blog | Softwarebay™</title>
        <link rel='canonical' href='https://softwarebay.vercel.app/latest-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Latest Blog | Softwarebay' />
        <meta
          property='og:description'
          content='SoftwareBay is the top platform for exploring and downloading software,the premier platform for the latest-page1 releases and secure downloads.'
        />

        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/latest-page1'
        />
      ...
      >
        SoftwareBay Latest Blog Blog Section.
      </h1>
      <Marquee />
      {/* <p
      ...
      <div className='container'>
        <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>Blog Section</h1>
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {latestp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/latest-page1/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/latestp1.json')
...
export default latestpage1Page
