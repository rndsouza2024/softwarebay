...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/latest/',
  headline: 'Download Latest | Softwarebay™',
  url: 'https://softwarebay.vercel.app/latest/',
  description:
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/latest/' />
        <meta
          name='robots'
        ...
        <meta
          ...
          content='SoftwareBay is the top platform for exploring and downloading software,the premier platform for the Latest Blog releases and secure downloads.'
        />

        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/latest'
        />
      ...
      >
        SoftwareBay Latest Blog Section.
      </h1>
      <Marquee />
      {/* <p
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/latest.json')
