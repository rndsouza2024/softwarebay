...
import developmentp1Data from '../../public/developmentp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/development-page1/',
  headline: 'Download development | Softwarebay™',
  url: 'https://softwarebay.vercel.app/development-page1/',
  description:
    'SoftwareBay is the top platform for exploring and downloading software,the premier platform for the latest releases and secure downloads.',
  image: 'https://softwarebay.vercel.app/wp-content/uploads/development.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Development',
      item: 'https://softwarebay.vercel.app/development/'
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'Development Page 1',
      item: 'https://softwarebay.vercel.app/development-page1/'
    }
  ]
})
const developmentp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Download Development | Softwarebay™</title>
        <link rel='canonical' href='https://softwarebay.vercel.app/development-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Development | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/development-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, movies, mobile, games, graphic design, file sharing, education, development, development, browser'
        />
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/development.webp'
        />
      ...
      >
        SoftwareBay Development Section.
      </h1>
      <Marquee />
      {/* <p
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>developmentp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {developmentp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/development-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="development" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/developmentp1.json')
