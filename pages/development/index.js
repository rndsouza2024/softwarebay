...
const uwatchfreeSchema = JSON.stringify([
  {
    ...
    image: [
      'https://softwarebay.vercel.app/favicon.ico'
    ],
    logo: {
      '@type': 'ImageObject',
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/development/',
  'headline': 'Download Development | Softwarebay™',
  'url': 'https://softwarebay.vercel.app/development/',
  ...
  'image': 'https://softwarebay.vercel.app/wp-content/uploads/dvelopment.webp',
  'author': {
    '@type': 'Person',
    'name': 'DrTrailer',
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <meta
          property='og:title'
          content=' Download development | Softwarebay'
        />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/development'
        />
        ...
        <meta
          ...
          content='https://softwarebay.vercel.app/wp-content/uploads/dvelopment.webp'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>development Section</h1> */}
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/development.json')
