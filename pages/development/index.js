...
const softwareSchema = JSON.stringify({
  ...
  softwareVersion: 'Development 2024',
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
       <Head>
        ...
        <link rel='canonical' href="https://softwarebay.vercel.app/development/" />
        <meta
          name='robots'
       ...
       <meta name='robots' content='index, follow' />
        ...
        <meta
          ...
          content='Explore. Discover. Download - Free Your Desired Software.'
        />
        <meta property='og:url' content= "https://softwarebay.vercel.app/development"/>
      ...
      <Script src="../../propler/ads.js" defer />
        ...
        <h1  className='badge bg-gradient-to-r from-pink-500 to-amber-500 font-bold py-3 px-6  shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'  style={{
          ...
          textAlign: 'center',
          marginBottom: '15px'
        }}>SoftwareBay Development Section.</h1>
