...
import utilitiesp1Data from '../../public/utilitiesp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/utilities-page1/',
  headline: 'Download Utilities | Softwarebay™',
  url: 'https://softwarebay.vercel.app/utilities-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/utilities.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'Utilities Page 1',
      item: 'https://softwarebay.vercel.app/utilities-page1/'
    }
  ]
})
const utilitiesp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/utilities-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Utilities | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/utilities-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, utilities, utilities, utilities, utilities, utilities, utilities, graphic design, file sharing, utilities, utilities, utilities, browser'
        />
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/utilities.webp'
        />
        <meta name='utilities-web-app-capable' content='yes' />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>utilitiesp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {utilitiesp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/utilities-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="utilities" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/utilitiesp1.json')
