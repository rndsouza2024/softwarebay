...
const utilitiesDetail = ({ utilitiesItem }) => {
  ...
  }, [utilitiesItem, enableNoiseCancellation])
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: utilitiesItem.synopsis,
        image: utilitiesItem.image,
        ...
        <div className='flex-container'>
          <div className='category-container'>
            ...
            >
              ...
              {' '}
              Author: {utilitiesItem.group}.
            </h2>
             <Image
                src={utilitiesItem.directorimg}
                alt={utilitiesItem.group}
                width={100}
                height={100}
                quality={90}
                objectFit='cover'
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={utilitiesItem.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {utilitiesItem.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {utilitiesItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {utilitiesItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={utilitiesItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${utilitiesItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
                    ...
                    {showTimer && seconds <= 0 && (
                      <div>
                        {utilitiesItem.downloadlink && (
                          <Link href={utilitiesItem.downloadlink} target='_blank'>
                            <div
                        ...
                        {utilitiesItem.downloadlink1 && (
                          <Link href={utilitiesItem.downloadlink1} target='_blank'>
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
                              style={{
                                margin: 'auto',
