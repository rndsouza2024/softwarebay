...
const filesharingDetail = ({ filesharingItem }) => {
  ...
  }, [filesharingItem, enableNoiseCancellation])
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <meta
                          itemprop='name'
                          content={filesharingItem.title}
                        />
                        <meta
                          itemprop='description'
                          content=  {filesharingItem.text}
                        />
                        <meta
                          itemprop='uploadDate'
                          content=  {filesharingItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {filesharingItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={filesharingItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${filesharingItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
                    ...
                    {showTimer && seconds <= 0 && (
                      <div>
                        {filesharingItem.downloadlink && (
                          <Link href={filesharingItem.downloadlink} target='_blank'>
                            <div
                        ...
                        {filesharingItem.downloadlink1 && (
                          <Link href={filesharingItem.downloadlink1} target='_blank'>
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
                              style={{
                                margin: 'auto',
