...
import filesharingp1Data from '../../public/filesharingp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/file-sharing-page1/',
  headline: 'Download file-sharing | Softwarebay™',
  url: 'https://softwarebay.vercel.app/file-sharing-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/file-sharing.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'File Sharing Page 1',
      item: 'https://softwarebay.vercel.app/file-sharing-page1/'
    }
  ]
})
const filesharingp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/file-sharing-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download File Sharing | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/file-sharing-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, movies, mobile, file-sharing, graphic design, file sharing, file-sharing, file-sharing, file-sharing, browser'
        />
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/file-sharing.webp'
        />
      ...
      >
        SoftwareBay File Sharing Section.
      </h1>
      <Marquee />
      {/* <p
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>file-sharingp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {filesharingp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/file-sharing-page1/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/file-sharingp1.json')
