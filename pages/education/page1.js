...
import educationp1Data from '../../public/educationp1.json'
...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/education-page1/',
  headline: 'Download Education | Softwarebay™',
  url: 'https://softwarebay.vercel.app/education-page1/',
  description:
  ...
  image: 'https://softwarebay.vercel.app/wp-content/uploads/education.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
  ...
  itemListElement: [
    ...
    },
    {
    ...
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'Education Page 1',
      item: 'https://softwarebay.vercel.app/education-page1/'
    }
  ]
})
const educationp1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://softwarebay.vercel.app/education-page1/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Download Education | Softwarebay' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://softwarebay.vercel.app/education-page1'
        />

        <meta
          name='keywords'
          content='download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, movies, mobile, games, graphic design, file sharing, education, education, education, browser'
        />
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content='https://softwarebay.vercel.app/wp-content/uploads/education.webp'
        />
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>educationp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {educationp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/education-page1/${item.id}`}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="education" />
          </div>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://softwarebay.vercel.app/educationp1.json')
