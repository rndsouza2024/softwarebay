...
const educationDetail = ({ educationItem }) => {
  ...
  }, [educationItem, enableNoiseCancellation])
  ...
  return (
    <div>
      <Head>
        ...
        <title>
          {' '}
          Download {educationItem && educationItem.name} | Softwarebay
        </title>
        ...
        <meta
          name='keywords'
          content={`${educationItem && educationItem.keywords}`}
        />
          ...
          <div className='category-container'>
            ...
            >
              ...
              <p className='text-black text-bg font-semibold mt-2'>
                Version: {educationItem.version}
              </p>
              <p className='text-black text-bg font-semibold mt-2'>
                Developers: {educationItem.developers}
              </p>
              <p className='text-black text-bg font-semibold mt-2'>
                License: {educationItem.license}
              </p>
              <h2 className='text-black font-bold mt-2 text-sm mb-2 items-center justify-center '>
              {' '}
              Author: {educationItem.group}.
            </h2>
             <Image
                src={educationItem.directorimg}
                alt={educationItem.group}
                width={100}
                height={100}
                quality={90}
                objectFit='cover'
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        ...
                        <meta
                          itemprop='uploadDate'
                          content=  {educationItem.datePublished}
                        />
                        <meta
                          itemprop='thumbnailUrl'
                          content=  {educationItem.backimage}
                        />
                        <meta itemprop='duration' content='P34S' />
                        <meta
                          itemprop='embedUrl'
                          content={educationItem.videourl}
                        />
                      </div>
                      <iframe
                        frameborder='0'
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${educationItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
                    ...
                    {showTimer && seconds <= 0 && (
                      <div>
                        ...
                        {educationItem.downloadlink1 && (
                          <Link href={educationItem.downloadlink1} target='_blank'>
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
                              style={{
                                margin: 'auto',
                        ...
                        {educationItem.additionalLinks?.map((link, index) => (
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {educationItem.head3} </strong>
                </p>
              </div>
              <Image
                src={educationItem.image3}
                alt={educationItem.name}
                width={1280}
                height={720}
                quality={90}
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {educationItem.head4} </strong>
                </p>
              </div>
