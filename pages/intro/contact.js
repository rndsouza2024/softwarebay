  ...
  return (
    <div>
        ...
        <title>Softwarebay  | Contact Us</title>
          ...
          />
          <link rel='canonical' href='https://softwarebay.vercel.app/intro/contact' />
          ...
          <meta
            ...
            content='Explore. Discover. Download - Free Your Desired Software.'
          />
          <meta property='og:url' content='https://softwarebay.vercel.app/intro/contact/' />
          <meta
  ...
  <section className="mb-32 text-gray-800">
    <div className="flex flex-wrap">
      <div className="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
        ...
        Feel free to use the form below to provide us with your feedback, suggestions, or collaboration inquiries related to FilePuma. We welcome your input to help us echance our services and offerings.
        </p>
      
        <p className="text-gray-500 mb-6">
          To submit your email the following details to <strong>softwarebay@outlook.com</strong>:
        </p>
