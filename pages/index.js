...
const HomePage = () => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      {
        '@type': 'Person',
        '@id': 'http://softwarebay.vercel.app/author/education/',
        name: 'Dr Trailer',
        url: 'http://softwarebay.vercel.app/author/education/',
        image: {
          '@type': 'ImageObject',
    ...
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <div className='container'>
        <Head>
          ...
          /> */}
          {/* <link rel='canonical' href='http://softwarebay.vercel.app/' /> */}
          ...
          <meta
            ...
            content='Explore. Discover. Download - Free Your Desired Software.'
          />
          <meta property='og:url' content='http://softwarebay.vercel.app/' />
          <meta
        ...
        <h1  className='text-black bg-gradient-to-r from-pink-500 to-amber-500 font-bold py-3 px-6  shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'  style={{
          ...
          >
            ...
            <button className='border border-black p-2 m-1 hover:bg-orange-100'>
              <li id='menu-item-194' className='menu-tutorials'>
                <a
                  href='http://softwarebay.vercel.app/othersoftware/'
                  className='text-black hover:px-0 text-bg font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-xl'
                >
                  ...
                  <div key={browserItem.id} className='card'>
                    <a href={`/browsers/${browserItem.id}`}>
                      <div className='relative'>
                        ...
                        <div className='badge bg-gradient-to-r from-pink-500 to-amber-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'>{browserItem.badge}</div>
                      </div>
                    </a>
                  </div>
                ))}
