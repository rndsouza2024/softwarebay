...
const HomePage = () => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      {
        '@type': 'Person',
        '@id': 'https://softwarebay.vercel.app/author/security/',
        name: 'Dr Trailer',
        url: 'https://softwarebay.vercel.app/author/security/',
        image: {
          '@type': 'ImageObject',
                    ...
                    <a href={`/games/${gamesItem.id}`}>
                      ...
                      <div className='relative'>
                        <Image
                          ...
                          style={{
                            width: '150px', // Ensures the image is displayed at this width
