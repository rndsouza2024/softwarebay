...
export default function Footer() {
  return (
    ...
    <nav className="list-none mb-10">
      ...
      <li>
        <a href="https://softwarebay.vercel.app/browser" className="px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-xl font-bold hover:text-blue-800">Browser</a>
      </li>
      <li>
